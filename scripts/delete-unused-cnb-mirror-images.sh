...
delete_tag "cnb-xu-mirror-cuda" "12.8.1-zh-hans-vscode"
delete_tag "cnb-xu-mirror-local" "ffmpeg"
delete_tag "cnb-xu-mirror-local" "lib"
delete_tag "cnb-xu-mirror-local" "node"
delete_tag "cnb-xu-mirror-python3.12-libs" "coscmd"
delete_tag "cnb-xu-mirror-python3.12-libs" "sageattention-l40"
delete_tag "cnb-xu-mirror-python3.12-libs" "torch-2.9.1-cu130"
delete_tag "cnb-xu-mirror-python3.12-libs" "nunchaku-for-torch-2.9.1-cu130"
delete_tag "cnb-xu-mirror-python3.12-libs" "torch-2.11.0-cu130"
delete_tag "cnb-xu-mirror-python3.12-libs" "nunchaku-for-torch-2.11.0-cu130"
